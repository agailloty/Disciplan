...
namespace Disciplaner.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260604124506_AddCalendarToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoardLabel", b =>
                {
                    ...
                    b.ToTable("LabelBoards", (string)null);
                });

            modelBuilder.Entity("Disciplaner.Domain.Entities.Attachment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Disciplaner.Domain.Entities.CalendarToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("CalendarTokens", (string)null);
                });
            ...
            modelBuilder.Entity("Disciplaner.Domain.Entities.Label", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Disciplaner.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<int>("DefaultAssigneePolicy")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("_nextTicketNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(1)
            ...
            modelBuilder.Entity("Disciplaner.Domain.Entities.SavedView", b =>
                {
                    ...
                    b.Property<bool>("IsVisibleOnHome")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("OnlyAssignedToMe")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("OnlyReportedByMe")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("StatusCategories")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("LabelTicket", b =>
                {
                    ...
                    b.ToTable("LabelTickets", (string)null);
                });
            ...
            modelBuilder.Entity("BoardLabel", b =>
                {
                    ...
                    b.HasOne("Disciplaner.Domain.Entities.Label", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Disciplaner.Domain.Entities.Attachment", b =>
                {
                    ...
                    b.HasOne("Disciplaner.Domain.Entities.Comment", null)
                        .WithMany()
                        .HasForeignKey("CommentId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Disciplaner.Domain.Entities.Ticket", null)
                        .WithMany()
