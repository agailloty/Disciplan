...
{
    /// <summary>Returns all boards owned by the given user.</summary>
    Task<IReadOnlyList<BoardSummaryDto>> GetAllByUserAsync(string userId, CancellationToken cancellationToken = default);

    /// <summary>Returns a board with its full column and card tree.</summary>
    ...
    /// <summary>Renames or updates the description of an existing board.</summary>
    ...
    /// <summary>Permanently deletes a board and all its columns and cards.</summary>
